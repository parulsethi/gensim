BaseMetrics(object):
    ...
    def TopicModel():
        ...
        def get_coherence(self, model, corpus):
...
Log(BaseMetrics):
    ...
    def TopicModel(self, coherence="u_mass", coherence_texts=None, coherence_window_size=None, coherence_topn=10, diff_distance="kullback_leibler"):
...
Visdom(BaseMetrics):
    ...
    def TopicModel(self, viz_env=None, coherence="u_mass", coherence_texts=None, coherence_window_size=None, coherence_topn=10, diff_distance="kullback_leibler"):
        ...
        def on_epoch_end(self, epoch):
            ...
            if coherence:
                ...
                if epoch == 0:
                    # initial plot window
                    self.viz_coherence = viz_window.line(Y=coherence_value, X=np.array([epoch]), env=viz_env, opts=dict(xlabel='Epochs', ylabel='Coherence', title='Coherence (%s)' % coherence))
                else:
                    viz_window.updateTrace(Y=coherence_value, X=np.array([epoch]), env=viz_env, win=self.viz_coherence)
            ...
            if perplexity:
                ...
                if epoch == 0:
                    # initial plot window
                    self.viz_perplexity = viz_window.line(Y=perplexity, X=np.array([epoch]), env=viz_env, opts=dict(xlabel='Epochs', ylabel='Perplexity', title='Perplexity'))
                else:
                    viz_window.updateTrace(Y=perplexity, X=np.array([epoch]), env=viz_env, win=self.viz_perplexity)
